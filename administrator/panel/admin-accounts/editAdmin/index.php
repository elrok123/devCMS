	...
	try
	{
		if($_POST['adminPass'] == $_POST['adminPassVerify'] && $_POST['adminUsername'] != "" && $_POST['adminFirstname'] != "" && $_POST['adminSurname'] != "" && $_POST['adminEmail'] != "" && $_POST['adminSurname'] != "")
		{
			if($_POST['adminPassChange'] == "1")
			{
				...
				$statement->bindParam(":userID", $_POST['saveAdmin']);
...
<html>
	...
	<body>
		...
		<div id="main">
			...
			<h1 class="title">Add a new admin account:</h1>
			<div id="content1">
							...
							<td style="width: 60%; text-align: center; height: 40px; padding: 10px; border-left: solid 1px #dadada; border-right: solid 1px #dadada;">
								<form action="" method="post">
									<table>
										<tr>
											<?php
												$statement = $conn->prepare("SELECT ID, firstname, surname, username, email, password FROM users WHERE ID = :adminID");
												$statement->bindParam(":adminID", $_GET['adminToEdit']);
												$statement->execute();
												$adminDetails = $statement->fetch();
											?>
											<td style="text-align: right;">
												<input type="hidden" value="<?php echo $adminDetails['ID']; ?>" name="saveClient" />
												<label>Firstname: </label>
											</td>
											<td style="text-align: left;">
												<input type="text" tag="" alt="" name="adminFirstname" placeholder="Firstname" value="<?php echo $adminDetails['firstname']; ?>" /></br></br>
											</td>
										</tr>
										<tr>
											<td style="text-align: right;">
											...
											<td style="text-align: left;">
												<input type="text" tag="" alt="" name="adminSurname" placeholder="Surname" value="<?php echo $adminDetails['surname']; ?>" /></br></br>
											</td>
										</tr>
										<tr>
											<td style="text-align: right;">
											...
											<td style="text-align: left;">
												<input type="text" tag="" alt="" name="adminUsername" placeholder="Username" value="<?php echo $adminDetails['username']; ?>" /></br></br>
											</td>
										</tr>
										<tr>
											<td style="text-align: right;">
											...
											<td style="text-align: left;">
												<input type="text" tag="" alt="" name="adminEmail" placeholder="Email" value="<?php echo $adminDetails['email']; ?>" /></br></br>
											</td>
										</tr>
										<tr>
											<td style="text-align: right;">
											...
											<td style="text-align: left;">
												<input type="password" onclick="$('#adminPassChange').val(1)" tag="" alt="" name="adminPass" placeholder="Password" value="<?php echo $adminDetails['password']; ?>" required/></br></br>
											</td>
										</tr>
										<tr>
											<td style="text-align: right;">
											...
											<td style="text-align: left;">
												<input type="password" onclick="$('#adminPassChange').val(1)" tag="" alt="" name="adminPassVerify" value="<?php echo $adminDetails['password']; ?>" placeholder="Verify Password" required/></br></br>
											</td>
										</tr>
										<tr>
											...
											<td style="text-align: left;">
												<input type="hidden" id="adminPassChange" name="adminPassChange" value="0"/>
												<input type="submit" name="newAdminSubmit" value="Save Changes"/>
											</td>
										</tr>
									</table>
								</form>
